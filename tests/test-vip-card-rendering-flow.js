...
expect(indexPage, 'class="vip-card-spotlight" @tap.stop="onSpotlight(card.id)"', 'spotlight remains visible and stops card navigation')
...
expect(editPage, '/pages/user/detail?own=true&preview=true', 'edit preview has explicit own and preview markers')
