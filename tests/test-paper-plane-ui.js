...
const paperPlane = fs.readFileSync(path.join(root, 'pages/community/paper-plane.uvue'), 'utf8')
const datingPlanePath = path.join(root, 'pages/community/dating-plane.uvue')
const datingPlaneComposePath = path.join(root, 'pages/community/dating-plane-compose.uvue')
const paperPlaneMessagesPath = path.join(root, 'pages/community/paper-plane-messages.uvue')
const paperPlaneSentPath = path.join(root, 'pages/community/paper-plane-sent.uvue')
...
includes(paperPlane, '/pages/community/dating-plane-compose', 'dating send page route')
...
includes(datingPlane, "uni.reLaunch({ url: '/pages/community/paper-plane' })", 'dating reply returns to paper-plane home')
...
includes(datingPlaneCompose, "uni.reLaunch({ url: '/pages/community/paper-plane' })", 'dating send page returns home after sending')
...
includes(pagesConfig, 'pages/community/dating-plane', 'pages.json')
includes(pagesConfig, 'pages/community/dating-plane-compose', 'dating send page route')
includes(pagesConfig, 'pages/community/paper-plane-messages', 'paper-plane messages route')
includes(pagesConfig, 'pages/community/paper-plane-sent', 'paper-plane sent route')
...
assert.ok(!paperPlaneMessages.includes("uni.reLaunch({ url: '/pages/community/paper-plane' })"), 'paper-plane messages should not reset the paper-plane navigation stack')
