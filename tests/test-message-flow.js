...
includes(messagePage, 'XsaMessageCenter', 'message page reusable center')
includes(messagePage, 'mode="standard"', 'standard message center mode')
includes(messagePage, 'onShow(() =>', 'standard message page refreshes the center when shown again')
includes(messagePage, ':refresh-key="refreshKey"', 'standard message page drives reusable refresh state')
excludes(messagePage, 'getConversationPage', 'thin message page should not own center state')
