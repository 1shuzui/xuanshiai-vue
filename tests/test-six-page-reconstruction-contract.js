...
const publish = read('pages', 'community', 'publish.uvue')
const topicDetail = read('pages', 'community', 'topic-detail.uvue')
const userDetail = read('pages', 'user', 'detail.uvue')
const userEdit = read('pages', 'user', 'edit.uvue')
...
assert.match(userDetail, /raw\.card/)
assert.match(userDetail, /raw\.profile/)
assert.match(userDetail, /detail_locked/)
...
assert.match(userEdit, />基本资料</)
assert.match(userEdit, />工作情况</)
assert.match(userEdit, />婚恋情况</)
