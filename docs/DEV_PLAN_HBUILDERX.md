...
|---|---|---|---|
| 认证门槛 | 常规互动与申请认识仅实名；参与话题 / 带话题发布需双重 | 双重认证 = 实名 + 学历人工审核通过 | **按已同步口径执行。** 单身承诺书仅作可选加分；审核中不能冒充通过 |
...
| 认证 | 常规互动与申请认识仅实名；参与话题 / 带话题发布需双重；单身承诺书仅作可选加分；状态必须真实，审核中不能显示为通过 |
| 收藏 | 私有行为，仅自己可见 |
...
- [ ] 常规互动与申请认识仅校验实名；参与话题 / 带话题发布校验双重认证；单身承诺书仅作可选加分。
- [ ] 不允许审核中状态点亮“已完成门槛”。
